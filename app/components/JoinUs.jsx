...
const JoinUs = () => {
  return (
    <div className="join-grad">
      <AnimatedSection className="py-20 bg-gradient-to-b from-[#191b200a] to-[#2d1f3db5] text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <AnimatedSmallText className="text-lg md:text-xl text-gray-300 mb-8">
            ...
            experienced the warmth and connection of our AI companions. Start
            your journey today by leading your virtual relationship on{" "}
